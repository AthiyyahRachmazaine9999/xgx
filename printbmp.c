#include <alloc.h> 
    ...
    { 
        ...
        nRet = fopen(FileName,"rb"); 
        if(!nRet){ 
        printf(" print img not run "); 
        exit(0); 
        } 
     
        fread(&Obj, sizeof(Obj), 1, nRet); 
